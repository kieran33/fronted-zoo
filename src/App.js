    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/dashboard-admin/creation-personnels"
            element={<PageCreationComptePersonnels />}
          />
          <Route
            path="/dashboard-admin/modification-personnels"
            element={<PageModificationComptePersonnels />}
          />
          <Route
            path="/dashboard-admin/suppression-personnels"
            element={<PageSuppressionComptePersonnels />}
          />
          <Route
            path="/dashboard-admin/ajout-animaux"
            element={<PageAjouterAnimaux />}
          />
          <Route
            path="/dashboard-admin/modification-animaux"
            element={<PageModifierAnimaux />}
          />
          <Route
            path="/dashboard-admin/suppression-animaux"
            element={<PageSupprimerAnimaux />}
          />
          <Route
            path="/dashboard-admin/ajout-services"
            element={<PageAjouterServices />}
          />
          <Route
            path="/dashboard-admin/modification-services"
            element={<PageModifierServices />}
          />
          <Route
            path="/dashboard-admin/suppression-services"
            element={<PageSupprimerServices />}
          />
          <Route
            path="/dashboard-admin/ajout-habitats"
            element={<PageAjouterHabitats />}
          />
          <Route
            path="/dashboard-admin/modification-habitats"
            element={<PageModifierHabitats />}
          />
          <Route
            path="/dashboard-admin/suppression-habitats"
            element={<PageSupprimerHabitats />}
          />
          <Route
            path="/dashboard-admin/etat-animaux"
            element={<PageEtatAnimauxAdmin />}
          />
          <Route
            path="/dashboard-admin/modifier-horaires"
            element={<PageModifierHoraires />}
          />
          <Route
            path="/dashboard-admin/etat-habitats"
            element={<PageEtatHabitatsAdmin />}
          />
          <Route
            path="/dashboard-admin/animaux-populaires"
            element={<AnimauxPopulaires />}
          />

          <Route
            path="/dashboard-employe/ajout-services"
            element={<PageAjouterServicesEmploye />}
          />
          <Route
            path="/dashboard-employe/modification-services"
            element={<PageModifierServicesEmploye />}
          />
          <Route
            path="/dashboard-employe/modifier-services/:id"
            element={<DetailsModificationServicesEmploye />}
          />
          <Route
            path="/dashboard-employe/suppression-services"
            element={<PageSupprimerServicesEmploye />}
          />
          <Route
            path="/dashboard-employe/ajout-nourriture"
            element={<PageNourrirAnimauxEmploye />}
          />
          <Route
            path="/dashboard-employe/ajout-nourriture/:id/:prenom"
            element={<DetailsAjoutNourritureAnimaux />}
          />
          <Route
            path="/dashboard-employe/moderer-avis"
            element={<AvisModerationEmploye />}
          />
          <Route
            path="//dashboard-employe/questions-visiteurs"
            element={<QuestionsVisiteurs />}
          />

          <Route
            path="/dashboard-veterinaire/compte-rendu-animaux"
            element={<CompteRenduAnimaux />}
          />
          <Route
            path="/dashboard-veterinaire/compte-rendu-animaux/:id/:prenom"
            element={<DetailsCompteRenduAnimaux />}
          />
          <Route
            path="/dashboard-veterinaire/avis-habitats"
            element={<PageAvisHabitats />}
          />
          <Route
            path="/dashboard-veterinaire/aivs-habitats/:id"
            element={<DetailsAvisHabitats />}
          />

          <Route
            path="/dashboard-admin/modifier-animaux/:id/:prenom"
            element={<DetailsModificationAnimaux />}
          />
          <Route
            path="/dashboard-admin/modifier-services/:id"
            element={<DetailsModificationServices />}
          />
          <Route
            path="/dashboard-admin/modifier-habitats/:id"
            element={<DetailsModificationHabitats />}
          />
          <Route
            path="/dashboard-admin/modifier-personnels/:id"
            element={<DetailsModificationPersonnels />}
          />
          <Route
            path="/dashboard-admin/modifier-horaires/:id"
            element={<DetailsModificationHoraires />}
          />
          <Route path="/dashboard-employe" element={<DashboardEmploye />} />
          <Route
            path="/dashboard-veterinaire"
            element={<DashboardVeterinaire />}
          />
